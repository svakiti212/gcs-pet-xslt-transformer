...
<xsl:stylesheet version="1.0" xmlns:xsl="http://www.w3.org/1999/XSL/Transform"
    ...
    <xsl:import
            href="C:\Users\dxd316\Projects\test-import-xslt\src\main\resources\gold1b_nngn_quarterly_new.xsl"/>
    <xsl:import
            href="C:\Users\dxd316\Projects\test-import-xslt\src\main\resources\gold1b_renewal_letter_new.xsl"/>
        ...
        <fo:root xmlns:fo="http://www.w3.org/1999/XSL/Format">
            ...
            <fo:page-sequence master-reference="normal">
                <fo:flow flow-name="xsl-region-body">
                    ...
                    <xsl:call-template name="gold1b_nngn_quarterly_new"/>
                    <fo:block page-break-before="always"/>
                    <xsl:call-template name="gold1b_renewal_letter_new"/>
                </fo:flow>
            </fo:page-sequence>
        </fo:root>
    </xsl:template>
