...
<xsl:stylesheet version="1.0" xmlns:xsl="http://www.w3.org/1999/XSL/Transform"
    ...
    <xsl:include
            href="C:\Users\dxd316\Projects\test-import-xslt\src\main\resources\xsl-include-with-utils-1.xsl"/>
    <xsl:include
            href="C:\Users\dxd316\Projects\test-import-xslt\src\main\resources\xsl-include-with-utils-2.xsl"/>
    <xsl:include
            href="C:\Users\dxd316\Projects\test-import-xslt\src\main\resources\utils.xsl"/>
        ...
        <fo:root xmlns:fo="http://www.w3.org/1999/XSL/Format">
            ...
            <fo:page-sequence master-reference="normal">
                <fo:flow flow-name="xsl-region-body">
                    ...
                    <xsl:call-template name="xsl-with-utils-1"/>
                    <fo:block page-break-before="always"/>
                    <xsl:call-template name="xsl-with-utils-2"/>
                </fo:flow>
            </fo:page-sequence>
        </fo:root>
    </xsl:template>
